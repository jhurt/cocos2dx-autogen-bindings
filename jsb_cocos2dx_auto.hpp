...
JSBool js_cocos2dx_CCDirector_popSceneTransitionSlideInB(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCDirector_popSceneTransitionSlideInT(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCDirector_popSceneTransitionFade(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCDirector_popSceneTransitionCrossFade(JSContext *cx, uint32_t argc, jsval *vp);
